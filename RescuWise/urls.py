...
urlpatterns = [
    ...
    path('blog-article/', BlogArticle.as_view(), name='blogarticle'),
    path('blog/', BlogPage.as_view(), name='blogpage'),
    path('fundraising-causes/', Fundraising.as_view(), name='fundraising'),
    path('gallery-3-columns/', Gallery3.as_view(), name='gallery'),
    path('gallery-instagram-3-columns/', Instagram3.as_view(), name='instagram'),
